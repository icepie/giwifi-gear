...
/* renamed from: com.gbcom.gwifi.functions.template.builder.h */
public class FourColumnWithBorderBuilder implements ViewBuilder {
    ...
    public View mo26982a(Context context, ViewGroup viewGroup, JSONObject jSONObject, FragmentManager fragmentManager) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i += 4) {
            ...
            View inflate = GBApplication.instance().getLayoutInflater().inflate(C2425R.layout.tp_four_column_border_item, (ViewGroup) null);
            ...
            RelativeLayout relativeLayout3 = (RelativeLayout) inflate.findViewById(C2425R.C2427id.forth_item);
            if (i + 3 < jSONArray.length()) {
                JSONObject jSONObject5 = jSONArray.getJSONObject(i + 3);
                String string7 = jSONObject5.getString("title");
                String string8 = jSONObject5.getString("icon_url");
                ((TextView) inflate.findViewById(C2425R.C2427id.forth_item_title)).setText(string7);
                ImageTools.m14149a(string8, (ImageView) inflate.findViewById(C2425R.C2427id.forth_item_img), GBApplication.instance().options);
                relativeLayout3.setOnClickListener(new CommonClickListener(context, jSONObject5));
            } else {
