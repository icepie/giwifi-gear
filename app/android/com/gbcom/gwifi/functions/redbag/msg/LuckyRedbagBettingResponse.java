...
@UserMsgAndExecAnnotation(msgType = -4452)
public class LuckyRedbagBettingResponse extends AbstractMsg implements Serializable {
    protected LuckyRedbagBettingResponseBody response;
    protected ResponseHeader responseHeader = new ResponseHeader();

    public class LuckyRedbagBettingResponseBody implements Serializable {
        private int balance;
        ...
        public LuckyRedbagBettingResponseBody() {
        }
    ...
    public LuckyRedbagBettingResponse() {
        this.responseHeader.setCommand(-4452);
        this.response = new LuckyRedbagBettingResponseBody();
    }
    ...
    public LuckyRedbagBettingResponseBody getResponse() {
        return this.response;
    }

    public void setResponse(LuckyRedbagBettingResponseBody luckyRedbagBettingResponseBody) {
        this.response = luckyRedbagBettingResponseBody;
    }
}
