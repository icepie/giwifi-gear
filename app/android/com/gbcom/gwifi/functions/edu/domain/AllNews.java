...
public class AllNews {
    ...
    public static class DataBean {
        ...
        private List<PhotoNewsListBean> photo_news_list;
        ...
        public List<PhotoNewsListBean> getPhoto_news_list() {
            return this.photo_news_list;
        }

        public void setPhoto_news_list(List<PhotoNewsListBean> list) {
            this.photo_news_list = list;
        }
        ...
        public static class PhotoNewsListBean {
            private int comment_count;
            private String create_time;
